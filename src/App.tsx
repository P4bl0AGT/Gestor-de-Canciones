...
export default function App(){
  ...
  return (
    <div className="min-h-screen text-neutral-900 dark:text-neutral-100 overflow-x-hidden">
      <header className="sticky top-0 z-30 backdrop-blur bg-white/70 dark:bg-neutral-950/60 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-wrap items-center gap-3">
          ...
          <nav className="ml-0 sm:ml-4 flex gap-2">
            {([
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-4 py-4 grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
        {tab==='songs' && (
          <>
            <section className="min-w-0 lg:col-span-1 border rounded-2xl p-3 bg-white dark:bg-neutral-950 border-neutral-200 dark:border-neutral-800">
            ...
            <section className="min-w-0 lg:col-span-2 border rounded-2xl p-4 bg-white dark:bg-neutral-950 border-neutral-200 dark:border-neutral-800">
              {selectedSongId ? (
        ...
        {tab==='settings' && (
          <section className="min-w-0 lg:col-span-3 border rounded-2xl p-4 bg-white dark:bg-neutral-950 border-neutral-200 dark:border-neutral-800">
              ...
              {sec.lines.map((ln,i)=> (
                <div key={i} className="mb-4">
                  {(viewKind==='chords'||viewKind==='mixed') && !!ln.chords && (
                    <pre className="font-mono whitespace-pre-wrap break-words max-w-full overflow-x-auto bg-neutral-50 dark:bg-neutral-900 p-3 rounded-xl border border-neutral-200 dark:border-neutral-800">
                      {ln.chords.split('\n').map((line, idx)=> (
                ...
                {s.sections.map(sec=> (
                  <div key={sec.id} className="mb-4">
                    ...
                    {sec.lines.map((ln,i)=> (
                      <div key={i}>
                        {!!ln.chords && (
                          <pre className="font-mono whitespace-pre-wrap break-words max-w-full overflow-x-auto bg-neutral-50 dark:bg-neutral-900 p-2 rounded-lg border border-neutral-200 dark:border-neutral-800 mb-2">
                            {ln.chords.split('\n').map((line,j)=> (
